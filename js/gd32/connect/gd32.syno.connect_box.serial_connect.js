{
    let template = `
        <div :style="css_gd32_serial_connect">
            ...
            <button class="btn btn-primary btn-block" @click="connect" v-if="!is_connected" :style="css_button">
            连接设备<span class="glyphicon glyphicon-import"></span></button>
            <button class="btn btn-danger btn-block" @click="disconnect" v-if="is_connected" :style="css_button">
            断开连接<span class="glyphicon glyphicon-export"></span></button>
        </div>
    `;
    ...
    Vue.component('gd32_serial_connect', {
        template: template,
        data: data_css,
        methods: methods,
        created: function () {
